...
apa.cor.table(analytic.data, table.number = 1, filename = "Table 1.doc")
...
apa.reg.table(interaction.regression, table.number = 2, filename = "Table 2.doc")
...
intr.plot(b.0=49.2104,b.x=15.2537  ,b.z= 9.5471,b.xz= 6.0481, x.min=-2*sd.x,x.max=2*sd.x,z.min=-2*sd.z,z.max=2*sd.z, xlab="Anxiety Centered",zlab="Preparation Centered",ylab="Exam Score",expand=1,hor.angle=60,gray.scale=TRUE) 
